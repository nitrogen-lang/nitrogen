...
`
	...
	tests := []struct {
		...
		{token.Function, "fn", makePos(10, 11, "")},
		{token.LParen, "(", makePos(10, 13, "")},
		{token.Identifier, "x", makePos(10, 14, "")},
		{token.Comma, ",", makePos(10, 15, "")},
		{token.Identifier, "y", makePos(10, 17, "")},
		{token.RParen, ")", makePos(10, 18, "")},
		{token.LBrace, "{", makePos(10, 20, "")},
